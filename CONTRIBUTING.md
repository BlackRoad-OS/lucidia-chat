...
```bash
# Clone your fork
git clone https://github.com/YOUR_USERNAME/lucidia-chat.git
cd lucidia-chat

# Add upstream remote
git remote add upstream https://github.com/BlackRoad-OS/lucidia-chat.git
